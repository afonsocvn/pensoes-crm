...
export default function PipelineIndividualPage() {
    ...
    const fetchLeads = async () => {
        ...
        if (data) {
            const mappedData = data
                .filter(lead => lead.dimensao === 'Individual')
                .map(lead => {
    ...
    return (
        <div className="crm-main" style={{ padding: '2rem' }}>
            <div className="crm-header mb-6">
                <div>
                    <h1>Pipeline: Planos Individuais</h1>
                    <p className="crm-sub">Mova os leads individuais entre as fases de negócio (Drag & Drop)</p>
                </div>
            </div>
